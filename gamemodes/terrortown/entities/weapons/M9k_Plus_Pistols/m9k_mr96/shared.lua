...
SWEP.Gun = ("m9k_mr96") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "MR-96"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/mr96/v_pist_deagle.mdl"	-- Weapon view model
...
SWEP.Primary.Sound			= Sound("weapons/mr/deagle-1.wav")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector (-1.731, 0, 0.319)
...
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/weapons/mr96/w_pist_deagle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.161, -0.565, 1.593), angle = Angle(-3.82, 0.966, 180), size = Vector(1.338, 2.413, 1.338), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
