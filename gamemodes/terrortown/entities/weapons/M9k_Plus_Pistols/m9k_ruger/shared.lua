...
SWEP.Gun = ("m9k_ruger") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Ruger MK3"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/ruger/v_pist_fiveseven.mdl"	-- Weapon view model
...
SWEP.SightsPos = Vector (2.812, -0.301, 1.779)
...
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/weapons/ruger/w_pist_fiveseven.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.873, -0.002, 1.835), angle = Angle(-7.396, -5.084, 180), size = Vector(1.475, 1.475, 1.475), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
