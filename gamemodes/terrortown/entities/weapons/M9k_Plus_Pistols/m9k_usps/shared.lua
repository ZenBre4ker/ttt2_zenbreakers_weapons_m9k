...
SWEP.Gun = ("m9k_usps") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "H&K USP-S"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/usps/v_pist_usp.mdl"	-- Weapon view model
...
SWEP.Primary.Sound			= Sound("weapons/Navaro's USP/usp_unsil-1.wav")		-- Script that calls the primary fire sound
SWEP.Primary.SilencedSound = Sound("weapons/Navaro's USP/usp1.wav")
