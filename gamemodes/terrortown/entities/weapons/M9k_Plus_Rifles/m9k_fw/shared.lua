...
SWEP.Gun = ("m9k_fw") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "FW900K"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/fw900k/v_rif_galil.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_rif_aug.mdl"	-- Weapon world model
SWEP.Base 				= "bobs_scoped_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true

SWEP.Primary.Sound			= Sound("weapons/fw/galil-1.wav")		-- script that calls the primary fire sound
...
SWEP.Primary.KickHorizontal			= .8		-- Maximum up recoil (stock)
...
SWEP.Primary.Spread		= 0.2	--define from-the-hip accuracy 1 is terrible, .0001 is exact)
...
SWEP.SightsPos = Vector (-4.191, 0, 1.96)
