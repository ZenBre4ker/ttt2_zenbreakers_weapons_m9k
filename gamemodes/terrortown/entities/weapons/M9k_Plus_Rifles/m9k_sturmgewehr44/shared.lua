SWEP.Gun = ("m9k_sturmgewehr44") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Sturmgewehr 44"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/sturm/v_rif_ak47.mdl"	-- Weapon view model
...
SWEP.SightsPos = Vector(-6.711, -10.44, 0.685)
SWEP.SightsAng = Vector(1.07, 0.054, 0)
