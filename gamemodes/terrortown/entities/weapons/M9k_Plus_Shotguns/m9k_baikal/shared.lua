...
SWEP.Gun = ("m9k_baikal") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Baikal MP-153"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/baikal/v_shot_xm1014.mdl"	-- Weapon view model
...
SWEP.Primary.Sound			= Sound("BaikalLovesToFire")		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-2.84, 1.511, 1.006)
SWEP.IronSightsAng = Vector(0.646, 0, 0)

SWEP.SightsPos = Vector(-2.84, 1.511, 1.006)
SWEP.SightsAng = Vector(0.646, 0, 0)
